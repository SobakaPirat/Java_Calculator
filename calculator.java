...
public class calculator {
    ...
    public static class ROMAN{
        ...
        public static int ToInt(String number){  // из римских в арабские
        ...
        public static String ToRoman(int answer){       // из арабских в римские
    ...
    public static class CHECKER{
        ...
        public static void roman(){   // числа должны быть либо только римскими, либо только арабскими!
            if (ROMAN.roman_checker == 1){
                System.out.println("numbers should only be arabic or roman.");
                System.exit(0);
            }
        }
        public static int opearation(int num1_int,int num2_int,String operation){   // смотрим какую операцию ввел пользователь
            int answer = 0;
            if (operation.equals("+")){
    ...
    public static class CALCULATION{  // считаем пример
